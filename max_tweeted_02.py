# in this we're testing how the bot will choose users from followers
...
# this version chooses users from follower list instead of manual input
...
for user in users_list:
    ...
    #print(words_list)
    print(str(len(words_list)) + ' words')
